...
RESEARCH_WORKFLOW = {
    ...
    "steps": [
        ...
        },
        {
            ...
            "instruction": "Investigate anomalous zeros, abrupt changes, reporting coverage, missing categories, stale summaries, duplicate counts, and mismatched definitions. Seek contrary evidence. Distinguish missing observations from measured zero. Explain disagreements or retain them as unresolved; do not average incompatible counts or silently invent a correction.",
        ...
        },
        {
            ...
            "instruction": "Identify the inputs, selection choices, coverage gaps, and dependence assumptions that could change the conclusion. Vary them over evidence-supported or explicitly judgmental ranges and save the resulting comparisons. Distinguish annual variation, measurement error, forecast uncertainty, and model disagreement. Explain interval endpoints and mixture weights; an arbitrary percentage around one number is not a researched uncertainty model. Monte Carlo sampling does not create empirical support.",
